...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('App\Repositories\Car\CarRepositoryInterface', 'App\Repositories\Car\CarRepository');
        $this->app->bind('App\Repositories\Opportunity\OpportunityRepositoryInterface', 'App\Repositories\Opportunity\OpportunityRepository');
        $this->app->bind('App\Repositories\Want\WantRepositoryInterface', 'App\Repositories\Want\WantRepository');
