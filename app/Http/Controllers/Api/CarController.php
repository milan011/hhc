...
class CarController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function carFollow(Request $carRequest, $id)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function SaleOrUnsale(Request $request)
    {
        /*if($request->ajax()){
     ...
     * @return \Illuminate\Http\Response
     */
    public function carTouch(Request $request)
    {
        /*if($request->ajax()){
        echo "zhen de shi AJAX";
        }
