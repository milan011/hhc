...
class Shop extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['id', 'pid', 'name', 'provence_id', 'city_id', 'telephone', 'address', 'status', 'user_id'];
    ...
    public function belongsToCreater()
    {
        ...
        return $this->belongsTo('App\User', 'user_id', 'id')->select('id', 'nick_name', 'telephone');
    }
}
