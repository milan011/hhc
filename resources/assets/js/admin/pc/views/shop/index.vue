    ...
    <div class="app-container">
        ...
        <el-table v-loading="listLoading" :key="tableKey" :data="list" border fit highlight-current-row style="width: 100%;">
            ...
            <el-table-column :label="$t('shop.status')" show-overflow-tooltip align="center">
                <template slot-scope="scope">
                    <span>
                        <el-tag :type="scope.row.status | shopStatusFilter">{{ shopStatusMap[scope.row.status] }}</el-tag>
                    </span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form ref="dataForm" :rules="rules" :model="temp" :inline="true" label-position="right" label-width="100px" style="width: 100%;">
                ...
                <el-form-item :label="$t('shop.shopCity')">
                    <el-cascader :options="cityList" v-model="temp.shopCity" :show-all-levels="false">
                    </el-cascader>
                </el-form-item>
